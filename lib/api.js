...
export const charityWrite = ({ name, photo, desc, website, tags, venmo, gofundme, token }) => {
	return req("charities/write", { name, photo, desc, website, tags, venmo, gofundme, token });
};
